...
public class AppDbContext : DbContext
{
    ...
    private static void SeedData(ModelBuilder mb)
    {
        ...
        mb.Entity<CategoriaContabil>().HasData(
            ...
            new CategoriaContabil { Id = 8,  Nome = "Saldo de Abertura",        Tipo = "Entrada", ContaDebito = "45", ContaCredito = "59", GrupoDre = "",                   GrupoFluxoCaixa = "Financiamento", Ativo = true },
            new CategoriaContabil { Id = 9,  Nome = "Venda de Ativo",           Tipo = "Entrada", ContaDebito = "45", ContaCredito = "69", GrupoDre = "Proveitos e Ganhos", GrupoFluxoCaixa = "Investimento",  Ativo = true },
            new CategoriaContabil { Id = 10, Nome = "Comissão Recebida",        Tipo = "Entrada", ContaDebito = "45", ContaCredito = "62", GrupoDre = "Proveitos e Ganhos", GrupoFluxoCaixa = "Operacional",   Ativo = true },
            new CategoriaContabil { Id = 11, Nome = "Outras Entradas",          Tipo = "Entrada", ContaDebito = "45", ContaCredito = "63", GrupoDre = "Proveitos e Ganhos", GrupoFluxoCaixa = "Operacional",   Ativo = true },
            // SAÍDAS
            new CategoriaContabil { Id = 12, Nome = "Compra de Mercadoria",        Tipo = "Saída", ContaDebito = "71", ContaCredito = "45", GrupoDre = "Custos e Perdas", GrupoFluxoCaixa = "Operacional",    Ativo = true },
            new CategoriaContabil { Id = 13, Nome = "Pagamento a Fornecedor",      Tipo = "Saída", ContaDebito = "32", ContaCredito = "45", GrupoDre = "",                GrupoFluxoCaixa = "Operacional",    Ativo = true },
            new CategoriaContabil { Id = 14, Nome = "Salários",                    Tipo = "Saída", ContaDebito = "73", ContaCredito = "45", GrupoDre = "Custos e Perdas", GrupoFluxoCaixa = "Operacional",    Ativo = true },
            new CategoriaContabil { Id = 15, Nome = "INSS",                        Tipo = "Saída", ContaDebito = "73", ContaCredito = "36", GrupoDre = "Custos e Perdas", GrupoFluxoCaixa = "Operacional",    Ativo = true },
            new CategoriaContabil { Id = 16, Nome = "IRT",                         Tipo = "Saída", ContaDebito = "75", ContaCredito = "34", GrupoDre = "Custos e Perdas", GrupoFluxoCaixa = "Operacional",    Ativo = true },
            new CategoriaContabil { Id = 17, Nome = "IVA",                         Tipo = "Saída", ContaDebito = "75", ContaCredito = "34", GrupoDre = "Custos e Perdas", GrupoFluxoCaixa = "Operacional",    Ativo = true },
            new CategoriaContabil { Id = 18, Nome = "Impostos e Taxas",            Tipo = "Saída", ContaDebito = "75", ContaCredito = "34", GrupoDre = "Custos e Perdas", GrupoFluxoCaixa = "Operacional",    Ativo = true },
            new CategoriaContabil { Id = 19, Nome = "Despesa Administrativa",      Tipo = "Saída", ContaDebito = "72", ContaCredito = "45", GrupoDre = "Custos e Perdas", GrupoFluxoCaixa = "Operacional",    Ativo = true },
            new CategoriaContabil { Id = 20, Nome = "Energia / Água / Internet",   Tipo = "Saída", ContaDebito = "72", ContaCredito = "45", GrupoDre = "Custos e Perdas", GrupoFluxoCaixa = "Operacional",    Ativo = true },
            new CategoriaContabil { Id = 21, Nome = "Aluguer",                     Tipo = "Saída", ContaDebito = "72", ContaCredito = "45", GrupoDre = "Custos e Perdas", GrupoFluxoCaixa = "Operacional",    Ativo = true },
            new CategoriaContabil { Id = 22, Nome = "Combustível / Transportes",   Tipo = "Saída", ContaDebito = "72", ContaCredito = "45", GrupoDre = "Custos e Perdas", GrupoFluxoCaixa = "Operacional",    Ativo = true },
            new CategoriaContabil { Id = 23, Nome = "Compra de Equipamento",       Tipo = "Saída", ContaDebito = "11", ContaCredito = "45", GrupoDre = "",                GrupoFluxoCaixa = "Investimento",   Ativo = true },
            new CategoriaContabil { Id = 24, Nome = "Juros Bancários",             Tipo = "Saída", ContaDebito = "78", ContaCredito = "45", GrupoDre = "Custos e Perdas", GrupoFluxoCaixa = "Financiamento",  Ativo = true },
            new CategoriaContabil { Id = 25, Nome = "Amortização de Empréstimo",   Tipo = "Saída", ContaDebito = "33", ContaCredito = "45", GrupoDre = "",                GrupoFluxoCaixa = "Financiamento",  Ativo = true },
            new CategoriaContabil { Id = 26, Nome = "Outras Despesas",             Tipo = "Saída", ContaDebito = "76", ContaCredito = "45", GrupoDre = "Custos e Perdas", GrupoFluxoCaixa = "Operacional",    Ativo = true }
        );
