        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 17, true, "71", "Despesa", true, "Custo das Mercadorias Vendidas" },
                    { 18, true, "72", "Despesa", true, "Fornecimentos e Serviços de Terceiros" },
                    { 19, true, "73", "Despesa", true, "Gastos com Pessoal" },
                    { 20, true, "74", "Despesa", true, "Amortizações e Depreciações do Exercício" },
                    { 21, true, "75", "Despesa", true, "Impostos e Taxas" },
                    { 22, true, "76", "Despesa", true, "Outros Custos e Perdas Operacionais" },
                    { 23, true, "78", "Despesa", true, "Custos e Perdas Financeiras" },
                    { 24, true, "79", "Despesa", true, "Custos e Perdas Extraordinárias" },
                    { 25, true, "61", "Receita", false, "Vendas de Mercadorias e Produtos Acabados" },
                    { 26, true, "62", "Receita", false, "Prestações de Serviços" },
                    { 27, true, "63", "Receita", false, "Outros Proveitos e Ganhos Operacionais" },
                    { 28, true, "68", "Receita", false, "Proveitos e Ganhos Financeiros" },
                    { 29, true, "69", "Receita", false, "Proveitos e Ganhos Extraordinários" },
