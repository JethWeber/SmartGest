        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Corrente = table.Column<bool>(type: "boolean", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, false, true, "61", "45", "", "Proveitos e Ganhos", "Operacional", "Venda de Mercadoria", "Entrada" },
                    { 2, false, true, "62", "45", "", "Proveitos e Ganhos", "Operacional", "Prestação de Serviço", "Entrada" },
                    { 3, false, true, "31", "45", "", "", "Operacional", "Recebimento de Cliente", "Entrada" },
                    { 4, false, true, "63", "45", "", "Proveitos e Ganhos", "Operacional", "Outros Rendimentos", "Entrada" },
                    { 5, false, true, "51", "45", "", "", "Financiamento", "Capital Inicial", "Entrada" },
                    { 6, false, true, "33", "45", "", "", "Financiamento", "Empréstimo Bancário", "Entrada" },
                    { 7, false, true, "68", "45", "", "Proveitos e Ganhos", "Financiamento", "Juros Recebidos", "Entrada" },
                    { 8, false, true, "59", "45", "", "", "Financiamento", "Saldo de Abertura", "Entrada" },
                    { 9, false, true, "69", "45", "", "Proveitos e Ganhos", "Investimento", "Venda de Ativo", "Entrada" },
                    { 10, false, true, "62", "45", "", "Proveitos e Ganhos", "Operacional", "Comissão Recebida", "Entrada" },
                    { 11, false, true, "63", "45", "", "Proveitos e Ganhos", "Operacional", "Outras Entradas", "Entrada" },
                    { 12, false, true, "45", "71", "", "Custos e Perdas", "Operacional", "Compra de Mercadoria", "Saída" },
                    { 13, false, true, "45", "32", "", "", "Operacional", "Pagamento a Fornecedor", "Saída" },
                    { 14, false, true, "45", "73", "", "Custos e Perdas", "Operacional", "Salários", "Saída" },
                    { 15, false, true, "36", "73", "", "Custos e Perdas", "Operacional", "INSS", "Saída" },
                    { 16, false, true, "34", "75", "", "Custos e Perdas", "Operacional", "IRT", "Saída" },
                    { 17, false, true, "34", "75", "", "Custos e Perdas", "Operacional", "IVA", "Saída" },
                    { 18, false, true, "34", "75", "", "Custos e Perdas", "Operacional", "Impostos e Taxas", "Saída" },
                    { 19, false, true, "45", "72", "", "Custos e Perdas", "Operacional", "Despesa Administrativa", "Saída" },
                    { 20, false, true, "45", "72", "", "Custos e Perdas", "Operacional", "Energia / Água / Internet", "Saída" },
                    { 21, false, true, "45", "72", "", "Custos e Perdas", "Operacional", "Aluguer", "Saída" },
                    { 22, false, true, "45", "72", "", "Custos e Perdas", "Operacional", "Combustível / Transportes", "Saída" },
                    { 23, false, true, "45", "11", "", "", "Investimento", "Compra de Equipamento", "Saída" },
                    { 24, false, true, "45", "78", "", "Custos e Perdas", "Financiamento", "Juros Bancários", "Saída" },
                    { 25, false, true, "45", "33", "", "", "Financiamento", "Amortização de Empréstimo", "Saída" },
                    { 26, false, true, "45", "76", "", "Custos e Perdas", "Operacional", "Outras Despesas", "Saída" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "Activa", "Codigo", "Corrente", "Grupo", "IsDevedora", "Nome" },
                values: new object[,]
                {
                    { 1, true, "11", false, "Ativo", true, "Activos Fixos Tangíveis" },
                    { 2, true, "12", false, "Ativo", true, "Activos Intangíveis" },
                    { 3, true, "13", true, "Ativo", true, "Investimentos Financeiros" },
                    { 4, true, "18", false, "Ativo", false, "Amortizações Acumuladas" },
                    { 5, true, "22", true, "Ativo", true, "Mercadorias" },
                    { 6, true, "26", true, "Ativo", true, "Matérias-Primas e Subsidiárias" },
                    { 7, true, "31", true, "Ativo", true, "Clientes" },
                    { 8, true, "32", true, "Passivo", false, "Fornecedores" },
                    { 9, true, "33", true, "Passivo", false, "Empréstimos Obtidos" },
                    { 10, true, "34", true, "Passivo", false, "Estado e Outros Entes Públicos" },
                    { 11, true, "36", true, "Passivo", false, "Pessoal" },
                    { 12, true, "43", true, "Ativo", true, "Caixa" },
                    { 13, true, "45", true, "Ativo", true, "Depósitos Bancários" },
                    { 14, true, "51", null, "Capital", false, "Capital Social" },
                    { 15, true, "55", null, "Capital", false, "Reservas Legais" },
                    { 16, true, "59", null, "Capital", false, "Resultados Transitados" },
                    { 17, true, "71", null, "Despesa", true, "Custo das Mercadorias Vendidas" },
                    { 18, true, "72", null, "Despesa", true, "Fornecimentos e Serviços de Terceiros" },
                    { 19, true, "73", null, "Despesa", true, "Gastos com Pessoal" },
                    { 20, true, "74", null, "Despesa", true, "Amortizações e Depreciações do Exercício" },
                    { 21, true, "75", null, "Despesa", true, "Impostos e Taxas" },
                    { 22, true, "76", null, "Despesa", true, "Outros Custos e Perdas Operacionais" },
                    { 23, true, "78", null, "Despesa", true, "Custos e Perdas Financeiras" },
                    { 24, true, "79", null, "Despesa", true, "Custos e Perdas Extraordinárias" },
                    { 25, true, "61", null, "Receita", false, "Vendas de Mercadorias e Produtos Acabados" },
                    { 26, true, "62", null, "Receita", false, "Prestações de Serviços" },
                    { 27, true, "63", null, "Receita", false, "Outros Proveitos e Ganhos Operacionais" },
                    { 28, true, "68", null, "Receita", false, "Proveitos e Ganhos Financeiros" },
                    { 29, true, "69", null, "Receita", false, "Proveitos e Ganhos Extraordinários" },
                    { 30, true, "88", null, "Capital", false, "Resultado Líquido do Exercício" }
                });
